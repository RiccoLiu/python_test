...
```
{
    ...
    "configurations": [   // 调试配置数组，可以包含多个配置
        {   // 单个调试配置对象开始
            ...
            "program": "${workspaceFolder}/tools/train.py",  // 要调试的主程序路径
            ...
            "python": "/data3/lc/miniconda3/envs/openmmlab2/bin/python",  // 指定使用的 Python 解释器绝对路径
            ...
            "env": {  // 设置环境变量
                ...
                <!-- "CONDA_PREFIX": "/data3/lc/miniconda3/envs/openmmlab2",
                "CONDA_DEFAULT_ENV": "openmmlab2",
                "PYTHONPATH": "${workspaceFolder}:/data3/lc/miniconda3/envs/openmmlab2/lib/python3.8/site-packages" -->
            },
